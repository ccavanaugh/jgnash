...
public final class IndeterminateCheckBox extends JCheckBox {
    ...
    private static class CheckBoxIcon implements Icon, UIResource {
        ...
        private void drawFlush3DBorder(final Graphics g, final int x, final int y, final int w, final int h) {
            g.translate(x, y);
        ...
        private void drawPressed3DBorder(final Graphics g, final int x, final int y, final int w, final int h) {
            g.translate(x, y);
