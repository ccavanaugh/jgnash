...
public class ThemeManager {
    ...
    private static final String[] KNOWN = { "com.jgoodies.looks.plastic.PlasticLookAndFeel",
                    ...
                    "com.jgoodies.looks.plastic.PlasticXPLookAndFeel", "com.jgoodies.looks.windows.WindowsLookAndFeel",
    ...
    protected ThemeManager(final JFrame frame) {
        ...
        try { // This could fail if JGoodies is not available
            ...
            Logger.getLogger(ThemeManager.class.getName()).info("JGoodies L&F was not found");
        }
    ...
    private void addTheme(final String theme) {
        try {
            ...
            Logger.getAnonymousLogger().log(Level.WARNING, "Could not add theme: {0}", theme);
        }
    }
     ...
     * <p/>
     * The L&F menu will use this method to determine whether the various L&F options should be active or inactive.
     * 
    ...
    private static boolean isLookAndFeelAvailable(final String laf) {
        ...
        } catch (Exception e) { // If ANYTHING bad happens, return false
            return false;
        }
    }
    ...
    public static int getNimbusFontSize() {
        ...
        // if the returned value is zero, determine the default base font size and save it
        if (preferredSize == 0) {
