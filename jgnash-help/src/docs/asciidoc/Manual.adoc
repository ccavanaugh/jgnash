...
[[_gettingstarted]]
== Getting Started
The basic elements of jGnash are Accounts, Currencies, Securities, and Transactions.  Every account is assigned one
...
Error checking of _required_ form fields is performed real-time.  As information is entered you will notice buttons
such as kbd:[Enter] enable and disabled based on validity of what has been entered.
...
****
For simplicity, the terms used here to discuss changes in account balances will be *Increase* and *Decrease*.
...
Cleared:: The intended use is for manual reconciliation of a specific transaction prior to a full reconciliation for the period.
Reconciled:: The transaction has been reconciled manually or through use of the Reconciliation tool
