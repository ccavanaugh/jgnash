...
applications.  If at all possible, avoid use of QIF files and use an OFX or QFX
file.
...
equivalent to Categories for some other financial applications.
