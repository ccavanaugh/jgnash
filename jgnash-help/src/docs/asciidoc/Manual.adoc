...
Reported values will be rounded to integers if you select a _Scale_ of 0.  The upper limit of the _Scale_ option
is limited by the largest _Scale_ value of the Currencies you have configured.
