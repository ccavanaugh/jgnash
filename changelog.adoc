...
== Release 2.35.2
* 09/10/2018 Fixed a bug that was preventing initialization of a new user specified portable preference file. (Swing, Fx)
...
* 09/09/2018 Updated manual with proper use of escape characters on the command line.
* 09/06/2018 Drop use of log4j as it is no longer a required dependency.
