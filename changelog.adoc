...
* Add a Ticker column to the investment register
* Fix column sizing for high precision quantities of shares.

Release 2.29.0
--------------
TODO: Fix notes column bug
TODO: Fix 0 on remind later
...
* 01/04/17 Protect against a corrupt snooze value for reminders. (Fx)
* 12/01/16 Corrected NPE occurring during import of transactions. (Fx)
* 11/30/16 Improves behavior of background removal of securities history.
