...
* 01/21/2020 Updated to JavaFx 14-ea+7.
* 01/19/2020 Correctly handle a change to the Yahoo finance cookie expiration date.
* 01/01/2020 Transactions may now be filtered by user managed Tags.
* 01/01/2020 Transactions may now be tagged with user managed Tags.
