...
* 01/30/17 Corrected an OFX import regression that reduced effectiveness of detecting a duplicate import.
* 01/29/17 Entity trash was being checked too frequently. (GitHub Issue #21)
