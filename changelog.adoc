...
* Cache table column sizes for the Fx interface

Release 2.28.0
--------------
* 11/05/16 Improved visual feedback for placeholder accounts and values in the Budget interface. (Fx) (Feature Request 116)
