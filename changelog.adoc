...
* 07/01/2018 Removed support for handling old XML file formats from 2017.
* 07/01/2018 Removed Dump Heap button from Console Dialog because API use is restricted in future JVMs. (Swing)
