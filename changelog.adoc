...
== Release 3.2.1
* 07/07/2019 Selected Reminders may now be copied to the clipboard using CTRL-C.
* 07/06/2019 Selected Transactions may now be copied to the clipboard using CTRL-C.
