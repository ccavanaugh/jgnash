...
* 02/29/2020 Don't hide the resize columns button even if automatic sizing is enabled.
...
* 02/26/2020 The Tag Manger now filters out application specific tags to make selection easier.
