...
* Convert from File to Path nio so Jimfs may be used for unit tests
...
* 01/08/17 jGnash now uses a priority based model for the handling of internal tasks to prevent deadlocks from
           background operations.  This corrects some reported random freezing and hanging of the UI. (Swing, Fx)
* 01/07/17 Updated to the latest Hibernate dependency.
* 12/01/16 Corrected NPE occurring during import of transactions. (Fx)
* 11/30/16 Improved behavior of background removal of securities history.
