...
Release 2.33.1
--------------
* 08/18/17 Corrected an issue with optimal data storage in xml and bxds files caused by a regression introduced in 2.33.0
* 08/16/17 The OFX export will now generate required information for transfer between accounts
...
* 08/14/17 OFX import now supports transfers between accounts
