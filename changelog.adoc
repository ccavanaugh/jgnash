...
Release 2.31.0
--------------
* 04/15/17 Updated to the latest Hibernate dependency.
* 04/12/17 Updated to the latest FontAwesomeFx dependencies.
* 04/10/17 Corrected an IndexOutOfBoundsException occurring during Transaction import of a quantity not large enough
           to fill the table. (Fx)
