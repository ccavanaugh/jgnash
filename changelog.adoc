...
* 01/17/17 Minor corrections to translations.  Parts of text for some languages was corrupt due to an editor bug.
* 01/15/17 More stability improvements when under heavy background loads and using a relational database. (Swing, Fx)
