...
* 11/04/2019 Updated to the latest Hibernate dependency.
...
* 10/27/2019 Improve behavior of the Report dialog when manually changing the scale.  The auto fit size toggles will be
             cleared automatically.
* 10/27/2019 Updated to the latest JavaFX, POI, Hibernate and Netty dependencies.
...
* 10/05/2019 Update to the latest Hibernate and Netty dependencies.
