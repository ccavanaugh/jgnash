...
---------------------------------------
TODO: Check and prevent load of and old Hsqldb database

* 10/04/16 Add utility method to pack and upgrade older databases. (Fx)
* 09/07/16 Added work around for JavaFx bug JDK-8132897 causing a crash with use of a ComboBox. (Fx)
...
* 08/21/16 Updated to the latest Hibernate dependency.  Hsqldb (*.script) users will need to save to a different file
           format before updating to this release.  They may revert back to Hsqldb after the upgrade.
