...
Release 2.xx.x
--------------
* 04/06/17 Fixed an issue with importing OFX 1.x files with ugly white space formatting.
...
* 03/25/17 The payee for Reinvested Dividends was not being generated correctly.
* 03/24/17 OFX import of investment transactions is supported for Buys, Sells, Dividends, and Reinvested Dividends.
* 03/22/17 Corrected a random IllegalStateException occurring during transaction edits.
