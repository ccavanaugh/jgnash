 ...
 */
public class DetailedDecimalTextFieldBehavior2 extends ComboBoxBaseBehavior<BigDecimal> {
    ...
    public DetailedDecimalTextFieldBehavior2(final ComboBoxBase<BigDecimal> base) {
